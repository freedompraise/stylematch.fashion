...
const ManualCheckout: React.FC = () => {
  ...
  const handleProofsChange = (files: File[], additionalNotes: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Transaction reference validation removed - will be auto-generated
    ...
    try {
      ...
      // Create order with manual payment details
        ...
        // Manual payment fields (transaction_reference auto-generated by system)
    ...
    <div className="min-h-screen bg-background py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Mobile-First Layout: Bank Details & Order Summary First */}
            ...
            <Card className="border-amber-200 bg-amber-50">
              ...
              <CardContent className="text-amber-800">
                <ol className="space-y-2 text-sm">
                  ...
                  <li>2. Upload payment proof screenshots</li>
                  <li>3. Your order will be verified within 24 hours</li>
                </ol>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="lg:order-1 space-y-6">
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-background border-t lg:static lg:p-0 lg:bg-transparent lg:border-0">

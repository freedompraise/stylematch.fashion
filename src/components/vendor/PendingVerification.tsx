        ...
        <div className="w-full max-w-xs">
          <ol className="relative border-l border-gray-200">
            <li className="mb-10 ml-6">
              ...
              <p className="text-sm text-gray-500">You&apos;ve completed onboarding</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="flex absolute -left-3 justify-center items-center w-6 h-6 bg-gray-300 rounded-full ring-8 ring-white"></span>
              <h3 className="font-medium leading-tight">Under Review</h3>
              <p className="text-sm text-gray-500">Our team is checking your details</p>
            </li>
            
            <li className="ml-6">
              <span className="flex absolute -left-3 justify-center items-center w-6 h-6 bg-gray-200 rounded-full ring-8 ring-white"></span>
              <h3 className="font-medium leading-tight">Verification Complete</h3>
              <p className="text-sm text-gray-500">You&apos;ll get an email when approved</p>
            </li>
          </ol>
        </div>
      </div>

...
const Footer: React.FC = () => {
  return (
    <footer className="bg-baseContent text-primary-foreground pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">Fashion Blog</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <a href="mailto:info@stylematch.com" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">marketmatchofficial@gmail.com</a>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+2349074577147" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">+234 907 457 7147</a>
              </li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-primary-foreground/10 pt-8 mt-8 text-center md:text-left md:flex md:justify-between md:items-center">
